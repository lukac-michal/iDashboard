...
export class KeyboardShortcutService {
  ...
  getDefaults(): KeyboardShortcut[] {
    return [
      { id: 'toggle-visibility', keys: 'CommandOrControl+Shift+D', action: 'toggle-visibility', description: 'Show/hide dashboard', scope: 'app' },
      { id: 'toggle-fullscreen', keys: 'CommandOrControl+Shift+F', action: 'toggle-fullscreen', description: 'Toggle maximized mode', scope: 'app' },
